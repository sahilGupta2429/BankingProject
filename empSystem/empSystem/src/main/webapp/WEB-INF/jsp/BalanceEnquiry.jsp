...
<form:form class="well form-horizontal" action="balanceEnquiryRequest.html" method="get" commandName="transaction">
<fieldset>
<legend>BALANCE ENQUIRY</legend>
...
<div class="form-group"> 
 ...
 -->
	<div class="form-group">
  		...
  		<div class="col-md-4">
    	<button type="submit" class="btn btn-warning" >GET BALANCE</button>
  		</div>
	</div>
