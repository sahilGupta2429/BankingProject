	...
	<div id="f">
		<div class="container" style="margin-left: 30%; margin-right: 30%">
			<div class="row centered">
				<h3>WITHDRAW</h3>
				<p class="centered"><i class="icon icon-circle"></i><i class="icon icon-circle"></i><i class="icon icon-circle"></i></p>
					<form:form class="form-signin" action="withdrawRequest.html" method="get" commandName="transaction">
					<h4 style="color:white";>Account Id :</h4><form:input path="accountId" type="text" class="form-control" placeholder="Account Id"/><br>
					<h4 style="color:white";>Amount :</h4><form:input path="amount" type="text" class="form-control" placeholder="Amount"/><br>
					<button class="btn btn-lg btn-primary btn-block" type="submit">Submit</button>
					</form:form>
					<br>
					<br>
					<h4 style="color:white";>${balance}</h4>
					<h4 style="color:white";>${authenticationMessage}</h4>
			</div><!-- row -->
		</div><!-- container -->
	</div>	<!-- f -->
