	...
	<div id="f">
		<div class="container" style="margin-left: 30%; margin-right: 30%">
			<div class="row centered">
				<h3>LOGIN</h3>
				<p class="centered"><i class="icon icon-circle"></i><i class="icon icon-circle"></i><i class="icon icon-circle"></i></p>
					<form:form class="form-signin" action="loginRedirect.html" commandName="employee">
					<h4 style="color:white";>Username :</h4><form:input path="username" type="text" class="form-control" placeholder="Username"/><br>
					<h4 style="color:white";>Password :</h4><form:input path="password" type="password" class="form-control" placeholder="Password"/><br>
					<button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
					<br>
					<h4 style="color:white";><a href="EmployeeSignup.html#portfolio">New Employee Signup</a></h4>
					</form:form>
